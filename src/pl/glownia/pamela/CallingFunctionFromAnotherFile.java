...
public class CallingFunctionFromAnotherFile {
        ...
        public static String weekday(int mm, int dd, int yyyy) {
            ...
            if (WeekdayCalculator.is_leap(yyyy) && (MonthName.month_name(mm).equals("January") || MonthName.month_name(mm).equals("February"))) {
                total -= 1;
            }
